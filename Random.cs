...
namespace Cryptool
{
    ...
    public static class Rng
    {
        ...
        ///
        public static ulong
        U64(ulong min = UInt64.MinValue, ulong max = UInt64.MaxValue - 1)
        {
            if (min > max)
            {
            ...
            if (max == UInt64.MaxValue)
            {
                throw new ArgumentException("max must not be equal to UInt64.MaxValue ");
            }
            ...
            if (r == UInt64.MaxValue) r = UInt64.MaxValue - 1;
